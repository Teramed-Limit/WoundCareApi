...
`dotnet ef dbcontext scaffold "Server=localhost;Database=PACSServer;Trusted_Connection=True;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer --context PACSServerDbContext --context-dir Persistence --output-dir Core/Domain/PACSServer --use-database-names --force`
