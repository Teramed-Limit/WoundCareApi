...
namespace WoundCareApi.Core.Application.UseCases.CaseRecords.Commands.InsertCaseRecord;

public record InsertCaseRecordCommand(CaseFormDataDto FormData, string UserId)
    : IRequest<Result<CaseRecordDto>>;

public class InsertCaseRecordCommandHandler
    : IRequestHandler<InsertCaseRecordCommand, Result<CaseRecordDto>>
{
