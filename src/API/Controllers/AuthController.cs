...
public class AuthController : ControllerBase
{
    ...
    [AllowAnonymous]
    [HttpPost("login")]
    public async Task<ActionResult<AuthResponse>> Login([FromBody] LoginCredentials credentials)
    {
        // 驗證使用者
        var user = await _userService.ValidateUserAsync(credentials.UserId, credentials.Password);
        if (user == null)
        {
